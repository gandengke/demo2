...
import com.jd.easy.audience.task.plugin.step.dataset.udd.UddStatusGeneratorStep;
 ...
 */
public class OneIdUddTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(OneIdUddTest.class);
    ...
    public static void main(String[] args) {
        ...
        /**
         * usejoinsingle.json 用户数据单表配置（oneid结果or 其他字段结果）
         ...
         *
         */
        SparkStepSegment sparkSegment = getsparkstepInfo("../udd/userjoinmulti.json");
        try {
            //4.任务执行
            ...
            UddStatusGeneratorStep stepObj = (UddStatusGeneratorStep) c.newInstance();
            stepObj.setStepBean(stepBean);
            stepObj.validate();
            Dataset<Row> data = stepObj.calStatusData(sparkSession, (UddStatusBean) stepBean, true);
            data.printSchema();
            data.show();
        } catch (Exception e) {
            //5.异常统一处理
    ...
    private static SparkStepSegment getsparkstepInfo(String argPath) {
        ...
        try {
            //2.1
            System.out.println(OneIdUddTest.class.getResource("").getPath());
            File file = new File(OneIdUddTest.class.getResource("").getPath() + argPath);
            if (file.exists()) {
                try {
                    // 将文件转换成String
    ...
    private static void mockData(SparkSession sparkSession) {
        sparkSession.createDataFrame(initDatauser8(), initSchemauser8()).createOrReplaceTempView("one_id_4a_8_9");
        sparkSession.createDataFrame(initDatauser9(), initSchemauser9()).createOrReplaceTempView("one_id_4a_9_10");
        sparkSession.createDataFrame(initDatauseroinid(), initSchemauseroneid()).createOrReplaceTempView("cdp_one_id_test");
        sparkSession.sql("select * from one_id_4a_8_9").show();
        sparkSession.sql("select * from one_id_4a_9_10").show();
        sparkSession.sql("select * from cdp_one_id_test").show();
    }

    private static StructType initSchemauser8() {
        StructField id = DataTypes.createStructField("one_id", DataTypes.StringType, true);
        ...
        StructField orderQtty = DataTypes.createStructField("click", DataTypes.StringType, true);
        ...
        return DataTypes.createStructType(Lists.newArrayList(id, venderId, venderId2, latestTradeDate, orderQtty, tradeMoneySummary, dt));
    }

    private static List<Row> initDatauser8() {
        List<Row> data = new ArrayList<Row>();
        data.add(RowFactory.create("oneid_1", "user_8_1", "", "2022-02-17", "11", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("", "user_8_2", "user_9_2", "2022-03-16", "23", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("oneid_3", "", "user_9_3", "2022-03-16", "22", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("oneid_4", "user_8_4", "user_9_4", "2022-03-16", "23", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("", "", "user_9_5", "2022-03-16", "45", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("oneid_6", "user_8_5", "", "2022-03-16", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("oneid_6", "user_8_6", "user_9_6", "2022-03-16", "89", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("oneid_7", "user_8_7", "user_9_7", "2022-03-16", "67", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("oneid_8", "user_8_8", "user_9_8", "2022-03-16", "100", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("oneid_9", "user_8_9", "user_9_9", "2022-03-16", "120", "28521.68768", "2022-03-17"));
        return data;
    }
    ...
    private static StructType initSchemauser9() { //        StructField id = DataTypes.createStructField("id", DataTypes.IntegerType, true);
        ...
        StructField latestTradeDate = DataTypes.createStructField("latest_trade_date", DataTypes.StringType, true);
        StructField orderQtty = DataTypes.createStructField("view", DataTypes.StringType, true);
        StructField tradeMoneySummary = DataTypes.createStructField("trade_money_summary", DataTypes.StringType, true);
        StructField dt = DataTypes.createStructField("dt", DataTypes.StringType, true);
    ...
    private static List<Row> initDatauser9() {
        List<Row> data = new ArrayList<Row>();
        data.add(RowFactory.create("user_10_1", "", "2022-02-17", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("user_10_2", "user_9_2", "2022-03-16", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("", "user_9_3", "2022-03-16", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("user_10_4", "user_9_4", "2022-03-16", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("", "user_9_5", "2022-03-16", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("user_10_5", "", "2022-03-16", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("user_10_6", "user_9_6", "2022-03-16", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("user_10_7", "user_9_7", "2022-03-16", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("user_10_8", "user_9_8", "2022-03-16", "168", "28521.68768", "2022-03-17"));
        data.add(RowFactory.create("user_10_9", "user_9_9", "2022-03-16", "168", "28521.68768", "2022-03-17"));
